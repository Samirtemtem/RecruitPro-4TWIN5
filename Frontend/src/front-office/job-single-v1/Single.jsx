  ...
  const checkShortlistStatus = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_BACKEND_URL}/api/shortlisted-jobs/check?userId=${userId}&jobId=${jobId}`
      );
...
const toggleShortlist = async () => {
  ...
  const fetchMatchingData = async () => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/recommendations/jobs?candidateId=${userId}&jobId=${jobId}`);
  ...
  const trackJobInteraction = async (type) => {
    ...
    try {
      const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/recommendations/interaction`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const confirmApplication = async () => {
    ...
    try {
      const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/app/api/applications`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
