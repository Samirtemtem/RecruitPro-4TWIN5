...
const TeamLeadersList: React.FC = () => {
  ...
  const fetchTeamLeads = async () => {
    try {
      ...
      const response = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/user/team-leads`);
  ...
  const handleCreateTeamLeader = async (e: React.FormEvent) => {
    ...
    try {
      await axios.post(`${process.env.REACT_APP_BACKEND_URL}/api/user/team-leads`, newTeamLeader);
  ...
  const handleDeleteTeamLeader = async () => {
    ...
    try {
      await axios.delete(`${process.env.REACT_APP_BACKEND_URL}/api/user/team-leads/${teamLeaderIdToDelete}`);
