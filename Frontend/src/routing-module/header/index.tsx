    ...
    const fetchNotifications = async () => {
      ...
      if (currentUserId) {
        try {
          ...
          const countResponse = await axios.get(`http://localhost:5000/api/notifications/user/${currentUserId}/unread-count`);
          ...
          // Fetch notifications
          const notifResponse = await axios.get(`http://localhost:5000/api/notifications/user/${currentUserId}`);
