...
// Utility function to find or create a profile
const findOrCreateProfile = async (userId: string) => {
...
export const updateExperience = async (req: Request, res: Response) => {
  try {
    ...
    profile.experience = experienceIds;
    await profile.save();
...
export const uploadCV = async (req: Request, res: Response) => {
  try {
    ...
    // Use findOrCreateProfile instead of returning 404
    const profile = await findOrCreateProfile(userId);
