...
const JobCategorie = () => {
  ...
  // Helper function to normalize strings into translation keys
            ...
            <div className="content">
              ...
              <h4>
                <a
                  ...
                  aria-label={t(`category.${toTranslationKey(item.catTitle)}`)}
                >
                  {t(`category.${toTranslationKey(item.catTitle)}`)}
                </a>
              </h4>
              <p style={{ color: "#777" }}>
                {t(`jobNumber.${toTranslationKey(item.jobNumber)}`)}
              </p>
            </div>
          </div>
        </div>
