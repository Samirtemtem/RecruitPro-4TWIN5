...
const RegisterWizard: React.FC = () => {
  ...
  const handleNext = () => {
    ...
    // Only set direction and increment step if not on the last step
    if (activeStep < 6) {
      setDirection('next');
      setActiveStep(activeStep + 1);
    } else if (activeStep === 6) {
      // Don't set direction or increment step when submitting
      //handleSubmit();
    }
  };
                ...
                <div className="col-md-10 mx-auto">
                  <div className="">
                    <div className="card-body">
                      ...
                      {/* Loading Overlay */}
                      {isLoading && (
                        <div className="position-fixed w-100 h-100 top-0 left-0 d-flex justify-content-center align-items-center" style={{ 
                          ...
                          <div className="loading-animation">
                            <div className="loading-content text-center">
                              <div className="loading-spinner">
                                <svg width="50" height="50" viewBox="0 0 38 38" xmlns="http://www.w3.org/2000/svg" stroke="#3490dc">
                              ...
                              <div className="mt-3 text-primary fw-bold">Processing...</div>
                            </div>
                          </div>
                        </div>
                      )}
