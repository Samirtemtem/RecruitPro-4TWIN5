...
const NeedDetailsDep = () => {
    ...
    const handleAddSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await axios.post(`${process.env.REACT_APP_BACKEND_URL}/request/create`, requestData);
            alert("Request created successfully");
            // Make API call to the request-created endpoint
            await axios.patch(`${process.env.REACT_APP_BACKEND_URL}/need/needs/${id}/request-created`, requestData);
