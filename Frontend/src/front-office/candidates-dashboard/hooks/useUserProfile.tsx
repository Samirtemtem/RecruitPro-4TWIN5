...
export const useUserProfile = () => {
  ...
  const deleteEducation = async (educationId: string): Promise<{ success: boolean, data?: any, error?: string }> => {
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/profile/education/${educationId}`, {
        method: 'DELETE',
        headers: {
  ...
  const deleteExperience = async (experienceId: string): Promise<{ success: boolean, data?: any, error?: string }> => {
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/profile/experience/${experienceId}`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const deleteSkill = async (skillId: string): Promise<{ success: boolean, data?: any, error?: string }> => {
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/profile/skills/${skillId}`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const updateProfileSection = async (
    ...
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/profile/${endpoint}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
