...
interface Request {
  ...
  createdAt: string;
  deadline: string;
  typeContrat: "VACATAIRE" | "PERMANENT"; // Updated to typeContrat
}
    ...
    const fetchRequestDetails = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          deadline: new Date().toISOString(),
          typeContrat: data.typeContrat, // Updated to typeContrat
        });
      } catch (err) {
                  ...
                  <div className="list-group details-list-group mb-4">
                    ...
                    <div className="list-group-item">
                      <div className="d-flex align-items-center justify-content-between">
                        ...
                        <p className="text-gray-9">{request.typeContrat}</p>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <form>
                      ...
                      <div className="mb-3">
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            setFormData({ ...formData, typeContrat: e.target.value as JobPost["typeContrat"] })
                          }
                          required
                        >
